...
class AdminDesktopRejectedUsersListPage extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Obx(() {
        ...
        if (filteredUsers.isEmpty) {
          return Center(child: EmptyDataWidget(message: "No rejected users found."));
        }
  ...
  Widget _buildUserCard(UserModel user, BuildContext context) {
    final heroTag = 'user-card-${user.id}-rejected';
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        // Avatar with red border for rejected
                        Container(
                          width: 44,
                          height: 44,
                          decoration: BoxDecoration(
                    ...
                    Row(
                      children: [
                        ...
                        _miniChip(Icons.work_outline, user.userRole, Colors.orangeAccent),
                      ],
                    ),
                    ...
                    // Timestamp
                    Text(
                      "Rejected: ${user.updatedAt != null ? DateFormat('dd MMM yyyy').format(user.updatedAt!) : 'N/A'}",
                      style: TextStyle(
